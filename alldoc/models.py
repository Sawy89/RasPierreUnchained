...
class Supply(models.Model):
    ...
    def updateDistance(self):
        ...
        '''
        supply_prec = Supply.objects.filter(distance_total__lt=self.distance_total).order_by('-distance_total').first()
        self.distance = self.distance_total - supply_prec.distance_total
        self.save()
